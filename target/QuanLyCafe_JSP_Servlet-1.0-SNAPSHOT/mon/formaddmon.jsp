        ...
        <div class="layout-page">
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Form thêm món</h4>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <form action="them" method="post" enctype="multipart/form-data">
                                        ...
                                        %>
                                        <option value="<%=i.getId()%>"><%=i.tenDM%></option>
                                        <%
                                            }
                                        %>
                                    </select>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="basic-default-fullname" name="gia" />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-fullname">Mô tả</label>
                                            <input type="text" class="form-control" id="basic-default-fullname" name="mota" />
                                        </div>
                                        <div class="mb-3">
