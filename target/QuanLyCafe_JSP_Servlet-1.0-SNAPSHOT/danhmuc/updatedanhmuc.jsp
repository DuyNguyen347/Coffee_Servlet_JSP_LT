        ...
        <div class="layout-page">
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Form cập nhật danh mục</h4>
                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    %>
                                    <form action="capnhat?id=<%=category.getId()%>" method="post">
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-fullname">ID</label>
                                            <input type="text" class="form-control" id="basic-default-fullname" name="id" value="<%=category.getId()%>" readonly />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-fullname">Tên danh mục</label>
                                            <input type="text" class="form-control" id="basic-default-fullname" value="<%=category.tenDM%>" placeholder="" name="nameCategory"/>
                                        </div>
