            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-sm-4 col-8 header-top-right no-padding">
                    <ul>
                        ...
                        <li>
                            <a href="tel:(012) 6985 236 7512">0582484851</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="single-menu">
                    <div class="title-div justify-content-between d-flex">
                        <h4><%= listItem.get(i).getTenmon()%></h4>
                        <p class="price float-right">
                            <%= listItem.get(i).getGia()%>
                        </p>
                    </div>
                    <p>
                        <%= listItem.get(i).getMota()%>
                    </p>
                </div>
            </div>
            <%} %>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6>Về chúng  tôi</h6>
                    <p>
                        Quán được thành lập vào năm 1999, bắt nguồn từ tình yêu dành cho đất Việt cùng với cà phê và cộng đồng nơi đây. Ngay từ những ngày đầu tiên, mục tiêu của chúng mình là có thể phục vụ và góp phần phát triển cộng đồng bằng cách siết chặt thêm sự kết nối và sự gắn bó giữa người với người.
                    </p>
                    <p class="footer-text">
            ...
            <div class="col-lg-5  col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6>Newsletter</h6>
                    <p>Nhận tin tức mới nhất từ chúng tôi</p>
